...
;(function ($, window, document) {
    ...
    function Indicator(container, indOption) {
        ...
        gradient=this.ctx.createLinearGradient(150,50,0,170);
        gradient.addColorStop("0",indOption.filled.startColor);
        //gradient.addColorStop("1.0",indOption.filled.endColor);
    ...
    radialIndicator.defaults = {
        ...
        filled:{ startColor:'#fff222', endColor:'#222322' }
    };
